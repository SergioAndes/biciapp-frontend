...
const routes: Routes = [
    {path: 'CampusBici/login', component: OktaLoginRedirectComponent},
    {path: 'EcoEmpresa/login', component: OktaLoginRedirectComponent},
    {path: 'BiciUsuario/login', component: OktaLoginRedirectComponent},
